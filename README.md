...
## Финальные материалы хакатона

Комплект для кейсодержателей и экспертов находится в [`materials/final/`](materials/final/).

| Материал | Содержание |
|---|---|
| [Презентация](materials/final/NER_silk_way.pptx) | Финальная презентация команды «Шёлковый путь» |
| [Описание проекта](materials/final/PROJECT_DESCRIPTION_FINAL.md) | Аннотация, задача, решение, результаты, планы и распределение ролей |
| [01 — Продукт и MVP](materials/final/01_product_mvp.pdf) | Пользователь, проблема, гипотеза и реализованный сценарий |
| [02 — Проверка и результаты](materials/final/02_validation_results.pdf) | Качество, производительность и подтверждённые проверки |
| [03 — Вклад AI Product и пилот](materials/final/03_ai_product_pilot.pdf) | Продуктовые решения, риски и следующий шаг к пилоту |
