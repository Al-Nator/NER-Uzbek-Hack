...
2. `uzner-a100-s21-resources-v1.tar.zst` — 6 627 462 514 байт (6,17 GiB), отдельно от Git.
...
Версия кода новой поставки: `688309446bab50497a9669743080b7a6c63c7c2d`;
последующие документационные коммиты не меняют веса или runtime.
Архив локально находится в `output/organizers-a100-s21-v1/`.
Он ещё не опубликован в файловом хранилище: передайте сами два файла либо
загрузите их и отправьте ссылку. Один URL репозитория недостаточен.
Распаковка проверена: SHA-256 всех 31 файлов совпали; 24 файла bundle также
проверены его собственным manifest. SHA-256 самого архива проверен отдельно.
